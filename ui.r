             ...
             tabPanel('Brushed Scatterplot',
               sidebarLayout(
                 sidebarPanel(
                        ...
                        checkboxInput('sc_agg_data',
                                      'Aggregate Metrics by Assignment'),
                        conditionalPanel("input.sc_agg_data",
                                         radioButtons('sc_agg_type_x',
                                                      'Aggregation Method for X',
                                                      c('Mean',
                                                        'Median',
                                                        'Max',
                                                        'Min',
                                                        ...
                                                        '3rd Quartile'),
                                                      inline = TRUE),
                                         radioButtons('sc_agg_type_y',
                                                      'Aggregation Method for Y',
                                                      c('Mean',
                                                        'Median',
                                                        'Max',
                                                        'Min',
